...
Featuring a cosmic meditative space, surrounded by 3D Audio of stars and galaxies ---- Built On webVR, Meraki works on most VR HMD's, and is also playable on computer if no HMD is available (not recommended tho). 
